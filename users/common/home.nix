...
in
{
  ...
  home.activation.installMutableDesktopConfig = lib.hm.dag.entryAfter [ "writeBoundary" ] ''
          install -Dm0644 ${userFilesDir}/fcitx5/profile "$HOME/.config/fcitx5/profile"
          install -Dm0644 ${userFilesDir}/fcitx5/conf/chttrans.conf "$HOME/.config/fcitx5/conf/chttrans.conf"
          install -Dm0644 ${userFilesDir}/fcitx5/conf/notifications.conf "$HOME/.config/fcitx5/conf/notifications.conf"
          install -Dm0644 ${userFilesDir}/fcitx5/conf/pinyin.conf "$HOME/.config/fcitx5/conf/pinyin.conf"
          install -Dm0644 ${userFilesDir}/fcitx5/conf/punctuation.conf "$HOME/.config/fcitx5/conf/punctuation.conf"

          install -Dm0644 ${userFilesDir}/autostart/copyq.desktop "$HOME/.config/autostart/copyq.desktop"
          install -Dm0644 ${userFilesDir}/copyq/copyq.conf "$HOME/.config/copyq/copyq.conf"
          install -Dm0644 ${userFilesDir}/copyq/copyq-commands.ini "$HOME/.config/copyq/copyq-commands.ini"
          install -Dm0644 ${userFilesDir}/copyq/copyq-filter.ini "$HOME/.config/copyq/copyq-filter.ini"
          install -Dm0644 ${userFilesDir}/copyq/copyq-monitor.ini "$HOME/.config/copyq/copyq-monitor.ini"
          install -Dm0644 ${userFilesDir}/copyq/copyq_tabs.ini "$HOME/.config/copyq/copyq_tabs.ini"

          install -Dm0644 ${userFilesDir}/codex/skills/browser-control/SKILL.md "$HOME/.codex/skills/browser-control/SKILL.md"
